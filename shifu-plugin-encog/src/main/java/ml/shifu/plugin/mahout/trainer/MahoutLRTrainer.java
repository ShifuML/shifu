...
public class MahoutLRTrainer implements Trainer {
    ...
    public void train(PMMLDataSet dataSet, Params rawParams) throws Exception {
        ...
        OnlineLogisticRegression network = createNetwork(params,
                numActiveFields, numTargetFields);
        // train the data
    ...
    public Double calculateMSE(OnlineLogisticRegression network) {
        double mseError = 0;
    ...
    private OnlineLogisticRegression createNetwork(NNParams params,
