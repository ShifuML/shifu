...
public class EncogTrainRequestProcessor implements RequestProcessor {

    private static final Logger log = LoggerFactory.getLogger(EncogTrainRequestProcessor.class);
