...
/**
 * {@link IndependentWNDModel} is a light WND engine to predict WND model, the only dependency is shifu, guagua.
 *
 * <p>
...
public class IndependentWNDModel {
     ...
     * Model version
     */
    private static int version = CommonConstants.WND_FORMAT_VERSION;
    ...
    private IndependentWNDModel(WideAndDeep wideAndDeep, NormType normType, Map<Integer, Double> cutOffMap,
    ...
    public static IndependentWNDModel loadFromStream(InputStream input, boolean isRemoveNameSpace) throws IOException {
        DataInputStream dis;
        ...
        IndependentWNDModel.setVersion(version);
    ...
    public static int getVersion() {
        return IndependentWNDModel.version;
    }
    ...
    public static void setVersion(int version) {
        IndependentWNDModel.version = version;
    }
