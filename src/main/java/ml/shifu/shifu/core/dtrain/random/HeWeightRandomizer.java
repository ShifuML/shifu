...
/**
 * Copied from https://github.com/tensorflow/tensorflow/blob/63d75cf3332aa2d4e9dd487f1ebfb489756d334b/tensorflow/python/ops/init_ops.py#L1254
 */
public class HeWeightRandomizer extends AbstractWeightRandomizer {

    public HeWeightRandomizer() {
        super(System.currentTimeMillis());
    }

    public HeWeightRandomizer(long seed) {
        super(seed);
    }
    ...
    public void randomize(final BasicNetwork network, final int fromLayer) {
        ...
        double limit =  Math.sqrt(6.0 / ((double)fromCount));
