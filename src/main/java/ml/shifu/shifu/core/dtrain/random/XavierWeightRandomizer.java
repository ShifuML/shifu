...
/**
 * Copied from https://github.com/tensorflow/tensorflow/blob/63d75cf3332aa2d4e9dd487f1ebfb489756d334b/tensorflow/python/ops/init_ops.py#L1135
 */
public class XavierWeightRandomizer extends AbstractWeightRandomizer {
    
    public XavierWeightRandomizer() {
        super(System.currentTimeMillis());
    }

    public XavierWeightRandomizer(long seed) {
        super(seed);
    }
     ...
     *  and `toCount` is the number of output units in the weight tensor.
     * 
     * @param network
    ...
    public void randomize(final BasicNetwork network, final int fromLayer) {
        ...
        double limit =  Math.sqrt(6.0 / ((double)(fromCount + toCount)));
