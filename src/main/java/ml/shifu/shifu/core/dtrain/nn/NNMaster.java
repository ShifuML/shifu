...
public class NNMaster extends AbstractMasterComputable<NNParams, NNParams> {
    ...
    */
        ...
        try {
            ...
            if (existingModel != null) {
                ...
                if ( mspecCompareResult  == 0 ) { // same model structure
                    ...
                    this.fixedWeightIndexSet = fitExistingModelIn(existingModel.getFlat(), this.flatNetwork, this.fixedLayers);
     ...
     *          empty set.
     */
    public Set<Integer> fitExistingModelIn(FlatNetwork fromFlatNetwork, FlatNetwork toFlatNetwork, List<Integer> fixedLayers) {
