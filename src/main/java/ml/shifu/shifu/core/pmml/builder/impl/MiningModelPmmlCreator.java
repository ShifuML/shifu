...
public class MiningModelPmmlCreator extends AbstractSpecifCreator {

    public MiningModelPmmlCreator(ModelConfig modelConfig, List<ColumnConfig> columnConfigList) {
        super(modelConfig, columnConfigList);
    }

    @Override
    public boolean build(BasicML basicML, Model model) {
        model.setOutput(createNormalizedOutput());
        return true;
    }

    @Override
    public boolean build(BasicML basicML, Model model, int id) {
        model.setOutput(createNormalizedOutput(id));
        return true;
    }
}
