...
public class GainChartTemplate {
    ...
    public static String HIGHCHART_BASE_BEGIN = new StringBuilder(1000)
            ...
            .append("<head>")
            .append("\n")
            .append("  <script src=\"web/jquery.min.js\"></script>")
            .append("\n")
            .append("  <script src=\"web/bootstrap.min.js\"></script>")
            .append("\n")
            .append("  <link href=\"web/bootstrap.min.css\" rel=\"stylesheet\" />")
            .append("\n").append("  <script src=\"web/highcharts.js\"></script>")
