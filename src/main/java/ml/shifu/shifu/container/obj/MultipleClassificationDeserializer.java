 ...
 */
public class MultipleClassificationDeserializer extends JsonDeserializer<MultipleClassification> {
     ...
     */
    @Override
    public MultipleClassification deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException,
