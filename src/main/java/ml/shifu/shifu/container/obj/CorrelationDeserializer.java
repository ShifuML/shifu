 ...
 */
public class CorrelationDeserializer extends JsonDeserializer<Correlation> {
     ...
     */
    @Override
    public Correlation deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException,
