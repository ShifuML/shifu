...
public class NormalizeUDFTest {
    ...
    public void testExec() throws IOException {
        ...
        Assert.assertEquals("(1,-3.682916,-4,-3.697376,-1.870673,4,4,4,4,4,4,2.473354,-0.350425,-1.006885,-1.073463,4,4,4,4,4,4,-3.143228,-4,-3.127431,-1.575238,4,4,3.485806,4,4,4,1.0)", instance.exec(input).toString());
    }
    ...
    public void testNegativeScore() throws IOException {
        ...
        Assert.assertEquals(32, instance.exec(input).size());
        Assert.assertEquals("0|-0.669222|-0.360155|-0.655541|-0.665245|0.760396|-0.131633|-0.42296|-0.106827|-0.776776|0.605251|0.180771|1.365906|0.187499|-0.2242|-0.113539|-0.405283|-0.496319|0.243497|-0.263792|-0.641144|-0.570226|0.435128|-0.554922|-0.586301|0.119237|-0.440279|-0.620615|-0.207681|-0.705196|-0.339793|1.0", instance.exec(input).toDelimitedString("|"));
    }
