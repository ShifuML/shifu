...
public class DataDictionaryServiceTest {
    ...
    public void test() {
        ...
        module.set("DataDictionaryInitializer", "ml.shifu.shifu.di.builtin.TripletDataDictionaryInitializer");
        ...
        module.set("DataDictionaryInitializer", "ml.shifu.shifu.di.builtin.ArffDataDictionaryInitializer");
