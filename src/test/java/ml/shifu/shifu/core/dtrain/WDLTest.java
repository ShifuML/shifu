...
public class WDLTest {
  ...
  final private String modelConfigPath = "/example/cancer-judgement/ModelStore/ModelSet1/ModelConfigWDL.json";
  final private String compactModelConfigPath = "/example/cancer-judgement/ModelStore/ModelSet1/ModelConfigWDLCompact.json";
  final private String columnConfigPath = "/example/cancer-judgement/ModelStore/ModelSet1/ColumnConfigWDL.json";
  final private String compactColumnConfigPath = "/example/cancer-judgement/ModelStore/ModelSet1/ColumnConfigWDLCompact.json";
  final private String normDataPath = "/example/cancer-judgement/DataStore/NormDataSet1/part-01-wdl";
  final private String compactNormDataPath = "/example/cancer-judgement/DataStore/CompactNormDataSet1/part-01-wdl";
  ...
  public void testTrainNormalDataWithSelect() {
    new GuaguaMRUnitDriver<>(generateProperties(compactModelConfigPath, compactColumnConfigPath, normDataPath)).run();
  }
  ...
  public void testTrainCompactData() {
    new GuaguaMRUnitDriver<>(generateProperties(compactModelConfigPath, compactColumnConfigPath, compactNormDataPath)).run();
  }
