...
public class PigNormalizationRequestProcessor implements RequestProcessor {

    private static Logger log = LoggerFactory
            .getLogger(PigNormalizationRequestProcessor.class);
    ...
    private Map<String, String> execHDFS(Request req) throws Exception {
        ...
        if (fs.exists(pathResults)) {
            ...
            log.info((String) params.get("pathResult")
