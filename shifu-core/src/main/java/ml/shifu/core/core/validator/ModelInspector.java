...
import ml.shifu.core.container.meta.MetaFactory;
 ...
 * <p/>
 * Safety Testing include:
 * 1. validate the @ModelConfig against its meta data @links{src/main/resources/store/ModelConfigMeta.json}
...
public class ModelInspector {
     ...
     *
     * @param modelConfig - the model configuration that want to probe
     * @param modelStep   - the steps
     ...
     * @throws Exception Exception when checking model configuration
     */
     ...
     * @param modelConfig - model configuration to check
     * @return - the validation result
     * @throws IOException Exception when checking model configuration
     */
     ...
     *
     * @param varSelect - @ModelVarSelectConf settings for variable selection
     * @return - the result of validation
     * @throws IOException IOException may be thrown when checking file
     */
     ...
     *
     * @param dataSet - @RawSourceData to check
     * @param prefix  - the prefix to generate readable clauses
     ...
     *
     * @param dataSet - @ModelSourceDataConf to check
     * @return @ValidateResult
     * @throws IOException IOException may be thrown when checking file
     */
     ...
     * @param sourceType - the source type of data [local/hdfs/s3]
     * @param prefix     - the prefix to generate readable clauses
     * @return @ValidateResult
     * @throws IOException
     */
