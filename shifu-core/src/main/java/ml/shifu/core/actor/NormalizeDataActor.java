...
import ml.shifu.core.actor.worker.DataFilterWorker;
import ml.shifu.core.actor.worker.DataLoadWorker;
import ml.shifu.core.actor.worker.DataNormalizeWorker;
...
import ml.shifu.core.message.ScanNormInputDataMessage;
...
public class NormalizeDataActor extends AbstractActor {
    ...
    public NormalizeDataActor(final ModelConfig modelConfig, final List<ColumnConfig> columnConfigList, final AkkaExecStatus akkaStatus) throws IOException {
        ...
        final NormalizationService normalizationService = injector.getInstance(NormalizationService.class);
