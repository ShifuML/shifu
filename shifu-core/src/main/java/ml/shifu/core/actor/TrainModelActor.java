...
import ml.shifu.core.message.ScanTrainDataMessage;
 ...
 * stored under models/model0.nn,model1.nn....
 */
    ...
    public void onReceive(Object message) throws Exception {
        if (message instanceof AkkaActorInputMessage) {
            ...
            for (Scanner scanner : scanners) {
                dataLoadRef.tell(
                        new ScanTrainDataMessage(scanners.size(), isDryRun, scanner), getSelf());
            }
