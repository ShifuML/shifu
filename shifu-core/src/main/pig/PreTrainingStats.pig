...
SET job.name 'core statistic'

DEFINE IsDataFilterOut  ml.shifu.core.udf.PurifyDataUDF('$source_type', '$path_model_config', '$path_column_config');
DEFINE AddColumnNum     ml.shifu.core.udf.AddColumnNumUDF('$source_type', '$path_model_config', '$path_column_config', 'false');
DEFINE CalculateStats   ml.shifu.core.udf.CalculateStatsUDF('$source_type', '$path_model_config', '$path_column_config', 'false');
