...
public class RequestDispatcherTest {
    ...
    public void test1() throws Exception {
        ShifuRequest req = JSONUtils.readValue(new File("shifu-core/src/test/resources/models/wdbc/All/requests/1_CreateDictionaryRequest.json"), ShifuRequest.class);
        RequestDispatcher.dispatch(req);
    }

    //@Test
    public void test2() throws Exception {
        ShifuRequest req = JSONUtils.readValue(new File("shifu-core/src/test/resources/models/wdbc/All/requests/2_CreateModelElementRequest.json"), ShifuRequest.class);
        RequestDispatcher.dispatch(req);
    }

    //@Test
    public void test3() throws Exception {
        ShifuRequest req = JSONUtils.readValue(new File("shifu-core/src/test/resources/models/wdbc/All/requests/3_CreateMiningSchemaRequest.json"), ShifuRequest.class);
        RequestDispatcher.dispatch(req);
    }
